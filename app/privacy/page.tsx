...
const OPERATOR_NAME = "김정보";
const CONTACT_EMAIL = "mosara999@gmail.com";
...
export default function PrivacyPolicyPage() {
  return (
    <main className="mx-auto max-w-3xl px-6 py-12 text-[var(--text)]">
      ...
      <nav
        aria-label="목차"
        className="mb-12 rounded-lg border border-[var(--border)] bg-[var(--card-bg)] p-5"
      >
        <h2 className="mb-3 text-base font-semibold">목차</h2>
        <ol className="list-decimal space-y-1 pl-5 text-sm text-[var(--text-sub)]">
          <li>
            <a href="#s1" className="hover:text-[var(--accent)] hover:underline">
              개인정보의 처리 목적
            </a>
          </li>
          <li>
            <a href="#s2" className="hover:text-[var(--accent)] hover:underline">
              처리하는 개인정보의 항목
            </a>
          </li>
          <li>
            <a href="#s3" className="hover:text-[var(--accent)] hover:underline">
              개인정보의 처리 및 보유 기간
            </a>
          </li>
          <li>
            <a href="#s4" className="hover:text-[var(--accent)] hover:underline">
              개인정보의 파기 절차 및 방법
            </a>
          </li>
          <li>
            <a href="#s5" className="hover:text-[var(--accent)] hover:underline">
              개인정보 처리업무의 위탁
            </a>
          </li>
          <li>
            <a href="#s6" className="hover:text-[var(--accent)] hover:underline">
              정보주체의 권리·의무 및 행사방법
            </a>
          </li>
          <li>
            <a href="#s7" className="hover:text-[var(--accent)] hover:underline">
              개인정보의 안전성 확보 조치
            </a>
          </li>
          <li>
            <a href="#s8" className="hover:text-[var(--accent)] hover:underline">
              쿠키 운영 및 거부 방법
            </a>
          </li>
          <li>
            <a href="#s9" className="hover:text-[var(--accent)] hover:underline">
              개인정보 보호책임자
            </a>
          </li>
          <li>
            <a href="#s10" className="hover:text-[var(--accent)] hover:underline">
              권익침해 구제방법
            </a>
          </li>
          <li>
            <a href="#s11" className="hover:text-[var(--accent)] hover:underline">
              처리방침의 변경
            </a>
          </li>
        </ol>
      ...
      <section id="s9" className="mb-10 scroll-mt-20">
        ...
        <div className="rounded-lg border border-[var(--border)] bg-[var(--card-bg)] p-4 leading-relaxed">
          <p>
